...
When /^(?:|I )press first button "([^\"]*)"(?: within "([^\"]*)")?$/ do |button, selector|
...
When /^(?:|I) login as "([^\"]*)"/ do |role|
  ...
  steps %{
    ...
    When I fill in "email" with "#{role}@#{role}.co.uk"
    When I fill in "password" with "#{role}"
    When I press "SEND" within "form"
  }
end

Then /^I should see "([^"]*)" button/ do |name|
  find_button(name, match: :first).should_not be_nil
end
